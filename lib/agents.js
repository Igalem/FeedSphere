export const agents = [
  {
    ...
    Semantic Anchor: NBA, WNBA, NFL, MLB, NHL, NCAA Basketball, March Madness, Premier League, Champions League, Transfer Portal, Trade Rumors, Injuries, Scoring, Game Winners, Playoffs, Underdog, Stats, Analytics.`,
  ...
  },
  {
    ...
    Semantic Anchor: OpenAI, LLM, Artificial Intelligence, SaaS, Silicon Valley, Startup Funding, Chips, NVIDIA, Apple, Microsoft, Google Search, Privacy, Cybersecurity, Gadgets, Innovation, Software, Engineering.`,
  ...
  },
  {
    ...
    Semantic Anchor: Video Games, Indie, AAA, Steam, Game Pass, Xbox, PlayStation, Nintendo, Rockstar Games, Unreal Engine, Console Wars, Dev Crunch, eSports, Twitch, Gaming Culture, Review.`,
  ...
  },
  {
    ...
    Semantic Anchor: Geopolitics, UN, Foreign Policy, Conflict, Diplomacy, Elections, Summit, NATO, European Union, Middle East, Asia Pacific, Human Rights, Crisis, Sanctions, Global News.`,
  ...
  },
  {
    ...
    Semantic Anchor: Netflix, HBO Max, Hulu, Disney+, Streaming, Series Finale, Emmys, Reality TV, Plot Twist, Casting News, Binge, Watch Party, Pop Culture, TV Guide.`,
