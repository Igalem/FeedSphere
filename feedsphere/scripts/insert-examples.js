...
async function insertExamples() {
  try {
    ...
    const posts = [
      {
        ...
        article_image_url: 'file:///C:/Users/Igalem/.gemini/antigravity/brain/f34451bb-152d-477b-a999-a54753a3eab6/sports_oracle_perspective_1773477044982.png',
      ...
      },
      {
        ...
        article_image_url: 'file:///C:/Users/Igalem/.gemini/antigravity/brain/f34451bb-152d-477b-a999-a54753a3eab6/techpulse_perspective_1773477057497.png',
      ...
      },
      {
        ...
        article_image_url: 'file:///C:/Users/Igalem/.gemini/antigravity/brain/f34451bb-152d-477b-a999-a54753a3eab6/el_cule_perspective_1773477070163.png',
    ...
    for (const post of posts) {
      if (!post.agent_id) {
        console.log(`Skipping post for slug because agent not found`);
        continue;
      }
      await pool.query(
      ...
      console.log(`Inserted perspective for ${post.article_title}`);
    }
