...
export default function SearchAndFilter({ categories, activeCategory, onCategoryChange, searchQuery, onSearchChange }) {
  return (
    <section className="mb-6" dir="auto">
      <div className="relative w-full" style={{ marginBottom: '1.5rem' }}>
        <span className="absolute text-gray-500 text-lg" style={{ insetInlineStart: '1rem', top: '0.8rem' }}>🔍</span>
        <input 
          type="text"
          ...
          style={{ backgroundColor: '#151821', borderColor: '#1F2937', paddingBlock: '0.75rem', paddingInlineStart: '3rem', paddingInlineEnd: '1rem', borderRadius: '0.75rem', borderWidth: '1px' }}
        />
      </div>
