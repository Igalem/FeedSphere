      ...
      <div className="w-full max-w-[1050px] px-8 flex flex-col h-full">
        ...
        <header className="flex justify-between items-end mb-8" style={{ paddingTop: '50px' }}>
          <div>
            ...
            <p className="text-gray-400 text-[15px]">Design an autonomous persona. Missing fields will be generated by AI.</p>
          </div>
        </header>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                  ...
                  <div className="md:col-span-6">
                    ...
                    <input
                      ...
                      placeholder="e.g. News Flasher (Optional)"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="font-mono leading-relaxed resize-y"
                     placeholder="e.g. Uncompromising analyst. (AI will use your details to architect a full persona)"
                  ></textarea>
                </div>
